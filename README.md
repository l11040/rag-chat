...
> 💡 **처음 설정하시나요?** 상세한 단계별 가이드는 [환경 설정 가이드](docs/setup-guide.md)를 참고하세요.
> 
> 🚀 **빠른 설정**: 자동화된 설정 스크립트를 사용할 수 있습니다:
> ```bash
> ./scripts/setup.sh
> ```
...
- **[환경 설정 가이드](docs/setup-guide.md)**: 처음 프로젝트를 설정하는 분들을 위한 상세한 단계별 가이드
